...
public class CalendarEx1 {
	public static void main(String[] args) {
		...
		System.out.println("월(0:1월,1:2월 ~ 11:12월):" + (today.get(Calendar.MONTH)+1));
		System.out.println("년도기준 몇째주:" + today.get(Calendar.WEEK_OF_YEAR));
		System.out.println("월도기준 몇째주:" + today.get(Calendar.WEEK_OF_MONTH));
		...
		System.out.println("뷴(0~59):" + today.get(Calendar.MINUTE));
